...
const ProductList = (props) => {
  ...
  const { htmls, onPushTableLength } = props;
  ...
  useEffect(() => {
    ...
    if (htmls[0].match(/검색결과가 없습니다./g)) {
      setProductList([]);
      handlePushTableLength(0);
      return;
    }

    const tableLength = parseHTML(htmls[0])
      .getElementsByClassName('txtblue')[0]
      .innerText
      .match(/[0-9]{1,10}/g)[0];

    handlePushTableLength(tableLength);
